...
| A-11a Named service scope | B-04 | With an empty filter, “What is EC2?” retrieves only EC2 evidence and answers from the local EC2 overview. A question naming two supported services remains unscoped for cross-service retrieval. |
